 ...
 * - QUICKBOOKS_REALM_ID is optional for bootstrap and will be written after a successful OAuth flow
...
async function main() {
  ...
  try {
    ...
    console.error(
      "3. http://localhost:8000/callback is registered as a redirect URI in your Intuit app",
    );
